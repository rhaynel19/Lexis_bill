                  ...
                  <div className="flex items-end justify-center gap-4 flex-wrap">
                    <div className="text-center">
                      ...
                      <div className="flex items-end gap-1">
                        <span className="text-4xl md:text-5xl font-bold text-[#F9F6EE]">RD$950</span>
                        <span className="text-[#D4AF37] text-xl font-semibold mb-1 align-bottom">/mes</span>
                      </div>
                    </div>
                    ...
                    <div className="text-center relative">
                      ...
                      <div className="flex items-end gap-1">
                        <span className="text-4xl md:text-5xl font-bold text-[#F9F6EE]">RD$9,500</span>
                      </div>
