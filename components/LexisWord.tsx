  ...
  return (
    <span className={`inline-flex items-center font-sans font-bold uppercase tracking-widest ${className}`}>
      ...
      >
        ...
        <polygon points="50,25 25,75 75,75" stroke="#D97706" strokeWidth="2" fill="none" strokeLinejoin="miter" />
        {/* Nodes */}
      ...
      <span className="text-xl tracking-[0.15em] flex items-center">
        ...
        <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#D97706] to-[#F59E0B] drop-shadow-sm">LYZE</span>
        {showBill && (
